    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          salaryCurrency: { type: 'string', enum: ['VND', 'USD'], nullable: true },
          ...
          educationLevel: { type: 'string', enum: ['NONE', 'HIGH_SCHOOL', 'COLLEGE', 'BACHELOR', 'MASTER', 'PHD', 'TRAINING_CENTER'], nullable: true },
        },
      },
      response: {
        200: {
