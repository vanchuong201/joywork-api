                  ...
                  properties: {
                    ...
                    profile: {
                      ...
                      properties: {
                        ...
                        expectedSalaryMax: { type: 'integer', nullable: true },
                        ...
                        dayOfBirth: { type: 'integer', nullable: true },
                        monthOfBirth: { type: 'integer', nullable: true },
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          wardCodes: { type: 'array', items: { type: 'string' }, maxItems: 30 },
          specificAddress: { type: 'string', maxLength: 255, nullable: true },
          ...
          expectedSalaryMin: { type: 'integer', minimum: 0, nullable: true },
          expectedSalaryMax: { type: 'integer', minimum: 0, nullable: true },
          salaryCurrency: { type: 'string', enum: ['VND', 'USD', null], nullable: true },
          ...
          gender: { type: 'string', enum: ['MALE', 'FEMALE', 'OTHER', null], nullable: true },
