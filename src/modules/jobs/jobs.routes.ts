    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          title: { type: 'string', minLength: 1, maxLength: 200, description: 'Job title' },
          description: { type: 'string', minLength: 1, maxLength: 10000, description: 'Job description' },
          requirements: { type: 'string', maxLength: 5000, nullable: true, description: 'Job requirements' },
          responsibilities: { type: 'string', maxLength: 5000, nullable: true, description: 'Job responsibilities' },
          benefits: { type: 'string', maxLength: 2000, nullable: true, description: 'Job benefits' },
