      ...
      body: {
        ...
        properties: {
          ...
          wardCodes: {
            ...
            description: 'Headquarters ward codes',
          },
          specificAddress: { type: 'string', maxLength: 255, description: 'Headquarters specific address' },
              ...
              properties: {
                company: {
                  ...
                  properties: {
                    ...
                    wardCodes: { type: 'array', nullable: true, items: { type: 'string' } },
                    ...
                    verificationFileKey: { type: 'string', nullable: true },
                    verificationFileUrl: { type: 'string', nullable: true },
                    verificationSubmittedAt: { type: 'string', nullable: true },
                    verificationReviewedAt: { type: 'string', nullable: true },
                    verificationReviewedById: { type: 'string', nullable: true },
                    verificationRejectReason: { type: 'string', nullable: true },
  ...
  fastify.patch('/:companyId', {
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          name: { type: 'string', minLength: 2, description: 'Company name' },
          legalName: { type: ['string', 'null'], maxLength: 200, description: 'Registered business name' },
          slug: { type: 'string', minLength: 2, pattern: '^[a-z0-9-]+$', description: 'URL-friendly slug' },
          tagline: { type: ['string', 'null'], maxLength: 150, description: 'Company tagline' },
          description: { type: ['string', 'null'], maxLength: 10000, description: 'Company description (HTML allowed, sanitized server-side)' },
          logoUrl: { type: ['string', 'null'], format: 'uri', description: 'Company logo URL' },
          coverUrl: { type: ['string', 'null'], format: 'uri', description: 'Company cover image URL' },
          website: { type: ['string', 'null'], description: 'Company website URL (empty string or null allowed)' },
          ...
          specificAddress: { type: ['string', 'null'], maxLength: 255, description: 'Headquarters specific address' },
